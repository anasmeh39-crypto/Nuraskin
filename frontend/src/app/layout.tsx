...
export const metadata: Metadata = {
  ...
  description:
    "منتجات عناية بشرة مختارة بعناية لروتين يومي واضح. سيروم توازن وإشراقة البشرة بالنياسيناميد، كريم التجديد الليلي للبشرة، وسيروم نضارة محيط العين. الدفع عند الاستلام وتوصيل مجاني لجميع أنحاء المغرب.",
  keywords: ["عناية بشرة", "نورا سكين", "ناياسيناميد", "هالات", "مسام"],
  openGraph: {
