...
export const PRODUCTS: Product[] = [
  {
    ...
    heroTitle_ar: "سيروم النياسيناميد",
  ...
  },
  {
    ...
    keyResults: [
      ...
      { icon: "firm", text: "مظهر أكثر تماسكاً وحيوية مع الاستخدام المنتظم", image: "/images/nura-night-renewal-result-firm.png" },
    ],
  ...
  },
  {
    ...
    heroIngredient: "كافيين 5%",
    format: "سيروم محيط العين",
    volume: "15ml (4–6 أشهر)",
    benefits: [
  ...
  },
  {
    ...
    heroTitle_ar: "إيكران الشمس SPF 50",
    ...
    heroIngredient: "مرشحات أوروبية — بدون أثر أبيض",
...
const PRODUCT_PAGE_OFFER_RULES: Record<string, ProductPageOfferRule[]> = {
  ...
  "nura-eye-revive": [
    ...
    {
      id: "nura-eye-balance-duo",
      tier: "duo",
      label: "روتين الإشراقة",
      sublabel: "عيون مضوية + وجه متوازن — روتين الصباح",
      products: ["nura-eye-revive", "nura-balance"],
      price: 349,
      badge: "روتين يومي",
      bundleName: "روتين العين والنياسيناميد",
    },
    {
  ...
  "nura-spf-50": [
    ...
    {
      id: "nura-spf-balance-duo",
      tier: "duo",
      label: "روتين الصباح الأساسي",
      sublabel: "إشراقة + حماية — خطوتان كاملتان",
      products: ["nura-spf-50", "nura-balance"],
      price: 349,
      badge: "روتين يومي",
      bundleName: "روتين الإشراقة والحماية",
    },
    {
      id: "nura-morning-complete-trio",
      tier: "trio",
      label: "روتين الصباح الكامل",
      sublabel: "عيون مضوية + إشراقة + حماية كاملة",
      products: ["nura-spf-50", "nura-balance", "nura-eye-revive"],
      price: 449,
      badge: "مطلوب بزاف",
      bundleName: "روتين الصباح الكامل",
    },
