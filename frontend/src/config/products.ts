...
export const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    tagline_ar: "عويناتك كيبانو ديما عيانين؟ رجعي النضارة لمحيط العين ديالك.",
    description_ar:
    ...
    volume: "15ml",
    benefits: [
      "يخفف من مظهر الهالات السوداء مع الاستخدام المنتظم",
      "ينقص من البوفينيس (الانتفاخ) الصباحي",
      "يرطب الخطوط الرقيقة باش يبان الكونسيلر طبيعي",
      "تركيبة خفيفة وسريعة الامتصاص، مناسبة للمكياج",
    ],
    concerns: ["الهالات الداكنة", "الانتفاخات", "نظرة متعبة", "الخطوط الرقيقة حول العين"],
    ingredients: [
      {
        name_ar: "الكافيين",
        name_en: "Caffeine 5%",
        description_ar: "بحال شي قهوة ديال الصباح لعويناتك — كيعاون ينشط الدورة الدموية وينقص من الانتفاخ (البوفينيس).",
      },
      {
        name_ar: "النياسيناميد",
        name_en: "Niacinamide 5%",
        description_ar: "مكوّن مدروس علمياً كيضوي البلايص الداكنة مع الوقت وبطريقة آمنة، ويوحد لون محيط العين.",
      },
      {
        name_ar: "حمض الهيالورونيك",
        name_en: "Hyaluronic Acid",
        description_ar: "كيرطب بعمق باش يحيد دوك الخطوط الرقيقة ديال النشوفية، ويخلي الكونسيلر ديالك يبان طبيعي.",
      },
    ],
    ...
    reviews: [
      {
        ...
        city: "الدار البيضاء",
        rating: 5,
        text: "بشرتي ولات أكثر نضارة، والخطوط الرقيقة نقصو بزاف بعد 3 أسابيع ديال الاستعمال. أحسن حاجة هي المصداقية ديالهم، وما خلصت حتى وصلاتني لباب الدار.",
        date: "منذ شهر",
      },
      {
        name: "أسماء ق.",
    ...
    metaDescription:
      "سيروم نضارة محيط العين — يخفف الهالات ويرطب الخطوط الرقيقة. 249 درهم، الدفع عند الاستلام، توصيل لباب الدار.",
  },
  {
    slug: "nura-spf-50",
