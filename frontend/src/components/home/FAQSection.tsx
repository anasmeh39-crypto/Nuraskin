...
const faqs = [
  ...
  },
  {
    ...
    a: "نحرص على وصول منتجاتكِ بسرعة. التوصيل يستغرق عادةً من يومين إلى 4 أيام عمل لكافة مدن المغرب. سيتواصل معكِ مندوب التوصيل لتأكيد الموعد المناسب لكِ.",
  },
  {
  ...
  {
    q: "هل يتوفر الشحن المجاني؟",
    a: "نعم، يسعدنا تقديم الشحن المجاني لجميع الطلبات التي تتجاوز قيمتها 300 درهم. للطلبات الأقل، تبلغ تكلفة الشحن الرمزية 30 درهماً فقط.",
  },
];
