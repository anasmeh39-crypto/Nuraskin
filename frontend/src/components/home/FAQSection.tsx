...
const faqs = [
  ...
  },
  {
    ...
    a: "بسهولة تامة. صباحًا: تنظيف لطيف، سيروم توازن وإشراقة البشرة بالنياسيناميد، سيروم محيط العين، ثم واقي الشمس اليومي SPF 50. مساءً: تنظيف البشرة، سيروم محيط العين، ثم كريم التجديد الليلي.",
  },
  {
    q: "هل التوصيل مجاني؟",
