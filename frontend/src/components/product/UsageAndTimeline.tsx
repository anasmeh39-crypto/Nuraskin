...
function usageCopy(product: Product) {
  ...
  if (product.slug === "nura-spf-50") {
    return [
      ["01", "آخر خطوة صباحًا", "يوضع صباحًا كآخر خطوة في روتين العناية بالبشرة."],
      ["02", "قبل الخروج أو المكياج", "وزعي كمية مناسبة على الوجه والرقبة قبل الخروج أو قبل المكياج."],
      ["03", "استعمال يومي", "استخدميه كل صباح للحفاظ على إشراقة روتينك اليومي."],
    ];
  }
