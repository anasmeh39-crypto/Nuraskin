...
const BASE_FAQS = [
  {
    ...
    a: "صيغت لتكون لطيفة لمعظم أنواع البشرة. إذا كانت بشرتك حساسة، نوصي بتجربة كمية صغيرة على منطقة صغيرة أولاً خلال 24 ساعة.",
  },
  {
...
const PRODUCT_FAQS: Record<string, { q: string; a: string }[]> = {
  ...
  "nura-night-renewal": [
    ...
    {
      q: "هل يمكنني استخدامه مع مقشرات قوية؟",
      a: "نوصي بعدم الجمع بين خطوات قوية في نفس الليلة. ابدئي بروتين بسيط وراقبي تحمّل بشرتك.",
    },
  ],
  "nura-eye-revive": [
    {
  ...
  "nura-spf-50": [
    {
      q: "متى أستخدم واقي الشمس اليومي SPF 50؟",
      a: "يستخدم صباحًا كآخر خطوة في روتين العناية، ويفضل وضعه قبل التعرض للشمس بـ15 إلى 20 دقيقة.",
    },
    {
      q: "هل واقي الشمس مهم مع كريم التجديد الليلي؟",
      a: "نعم، خطوة الحماية صباحًا تساعد على الحفاظ على إشراقة البشرة، خصوصًا عند الالتزام بروتين ليلي للتجديد.",
    },
    {
      q: "هل يترك ملمسًا دهنيًا؟",
      a: "تركيبته خفيفة وسريعة الامتصاص ومصممة لتمنح لمسة مريحة غير دهنية تناسب الاستخدام اليومي.",
    },
    {
      q: "هل يجب إعادة تطبيقه خلال اليوم؟",
      a: "نعم، يُعاد تطبيقه كل ساعتين عند التعرض المستمر للشمس، وبعد السباحة أو التعرق أو التجفيف بالمنشفة.",
    },
  ],
};
