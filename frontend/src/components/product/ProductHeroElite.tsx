          ...
          >
            ...
            >
              {added ? (
                ...
                <>
                  {selectedOffer?.tier === "single"
                    ? `اطلبي ${product.slug === "nura-spf-50" ? "الإيكران" : product.slug === "nura-night-renewal" ? "الكريم" : "السيروم"} الآن — ${price} درهم`
                    : `احجزي روتينك الآن — ${price} درهم`}
