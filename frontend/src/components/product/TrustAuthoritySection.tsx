...
const TRUST_PILLARS = [
  ...
  },
  {
    ...
    title: "توصيل سريع في المغرب",
    description: "نوصل لجميع مدن المغرب خلال 2–4 أيام عمل. سائق التوصيل يتصل بك قبل الوصول لتأكيد الموعد.",
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
...
const BRAND_VALUES = [
  { title: "مصمم لاحتياجات المغرب", desc: "مناخنا، روتيننا، وتوقعاتنا اليومية" },
